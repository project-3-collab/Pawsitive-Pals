...
const ViewingRequest = () => {
    ...
    return (
        <>
            <Card>
                <Card.Header className="text-center">Pet name (pet ID)</Card.Header>
                <Card.Body>
                    ...
                    <Row className='text-center'>
                        <Col sm={6}>
                            <Button variant="success" size="lg" onClick={handleAcceptRequest}>
                                Accept
                            </Button> {' '}
                        </Col>
                        <Col sm={4}>
                            <Button variant="danger" size="lg" onClick={handleDenyRequest}>
                                Deny
                            </Button>
                        </Col>
                    </Row>
